...
# BEGIN AUTO-GENERATED HF DEPLOY CASES
# Generated by modelopt_qa_tools/case_generator. Edit rules in that tool,
# then regenerate this block instead of editing generated cases by hand.
...
def test_auto_generated_deploy_hf(command):
    command.run()
...
def test_auto_generated_eagle(command):
...
# END AUTO-GENERATED HF DEPLOY CASES
