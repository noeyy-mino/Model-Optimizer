...
@pytest.mark.parametrize(
    ...
    [
        ...
        *ModelDeployerList(
            model_id="nvidia/DeepSeek-V4-Flash-nvfp4-DSpark",
            backend=("trtllm", "vllm", "sglang"),
            tensor_parallel_size=8,
            mini_sm=100,
        ),
        *ModelDeployerList(
            model_id="nvidia/DeepSeek-V4-Pro-nvfp4-DSpark",
            backend=("vllm",),
            tensor_parallel_size=8,
            mini_sm=100,
        ),
...
@pytest.mark.parametrize(
    ...
    [
        ...
        *ModelDeployerList(
            model_id="nvidia/Qwen3.5-397B-A17B-NVFP4-V2",
            backend=("trtllm", "vllm", "sglang"),
            tensor_parallel_size=8,
            mini_sm=100,
        ),
...
@pytest.mark.parametrize(
    ...
    [
        ...
        *ModelDeployerList(
            model_id="nvidia/Kimi-K2.7-Code-NVFP4",
            backend=("trtllm", "vllm", "sglang"),
            tensor_parallel_size=8,
            mini_sm=100,
        ),
        *ModelDeployerList(
            model_id="nvidia/Kimi-K3-NVFP4",
            backend=("vllm",),
            tensor_parallel_size=8,
            mini_sm=100,
        ),
...
@pytest.mark.parametrize(
    ...
    [
        *ModelDeployerList(
            ...
            vllm_chat_kwargs={"chat_template_kwargs": {"enable_thinking": True}},
...
def test_nvidia_nemotron_3_ultra_550b_a55b_base_bf16(command):
    command.run()
...
@pytest.mark.parametrize(
    ...
    [
        *ModelDeployerList(
            model_id="nvidia/Mistral-Medium-3.5-128B-NVFP4",
            backend=("vllm",),
            tensor_parallel_size=4,
            mini_sm=100,
